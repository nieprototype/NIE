...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <div class="container">
            ...
            <div class="col-12">
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        ...
                        <h2 style="color: #E9AD28;">Discover the Right Course for you.</h2>
                        <br>
                    ...
                    <div class="col-5">
                        <img width="100%" src="img/courses/Asset.png">
                    </div>
        ...
        <section id="course1">
            ...
            <h2 style="font-weight: 400;">Most Popular Courses offered by NIE</h2>
            <br><br>
                ...
                <div class="row">
                    ...
                    <div style="text-align: right;" class="col-7">
                        ...
                        <h4 style="color: #4D5656; font-weight: 500;">Following table displays all the courses that are offered by
                            ...
                            application to your preferred course by clicking <span style="color: #E9AD28;">Download Application </span>button right next to the particular course.</h4>
                        <br>
