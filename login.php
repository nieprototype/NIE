<?php include "includes/header.html"; ?>
                ...
                <div class="col-lg-12">
                    ...
                    <div style="background-color: #E9AD28;" class="veen">
                        <div class="login-btn splits">
                            ...
                            <h3 style="color: #fff; font-size: 26px; font-family: 'Barlow Condensed', sans-serif;">
                                Already an user ?</h3>
                            <br>
                            <button class="active">Login</button>
                        </div>
                        <div class="rgstr-btn splits">
                            <h3 style="color: #fff; font-size:26px; font-family: 'Barlow Condensed', sans-serif;">Don't
                                have an account ?</h3>
                            <br>
                        ...
                        <div style="background-color: #1a1a1a;" class="wrapper">
                            <form id="hid1" autocomplete="off" style="background-color: transparent;">
                                ...
                                <h4 style="color: #fff; margin-bottom: 15px; margin-top: 10px; font-family: 'Barlow Condensed', sans-serif;">
                                    Login</h4>
                                <div class="mail">
    ...
    this.blur();    this.focus();  }" type="password" placeholder="Enter Password" name="password" required>
                            ...
                            <form id="hid2" autocomplete="off" style="background-color: transparent; display: none;"
                                  action="" method="POST">
                                <h2 style="color: #fff; font-family: 'Barlow Condensed', sans-serif;">NIE STAFF</h2>
