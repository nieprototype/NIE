<?php include 'includes/header.html' ?>
        ...
        <div class="wrapper wrapper--w780">
            <div class="card card-3 p-5">
                ...
                <form id="qf" class="mx-auto">
                    ...
                    <div class="input-group ">
                        <input class="input--style-3 " type="text" placeholder="Name" id="name" name="name" required>
                    </div>

                    <div class="input-group">
                        <input class="input--style-3" type="email" placeholder="Email" id="email" name="email" required>
                    </div>
                    <div class="input-group">
                        <input class="input--style-3" type="text" placeholder="Phone" id="phone" name="phone" required>
                    </div>
                    <div class="input-group">
                        <input class="input--style-3" type="text" placeholder="Queries" id="que" name="queries"
                               required>
                    ...
                    <div class=" w-100 mx-auto">
                        <p class="text-center">
                            ...
                            <button onclick="SubmitForm();" class="btn btn-warning  w-50" type="button">Submit</button>
                        </p>
                    </div>
                </form>
            </div>
    ...
    <script>
        ...
        function SubmitForm() {
            ...
            if (name !== '' && email !== '' && phone !== '' && que !== '') {

                swal.fire("Successfully Submitted !", "Form Submitted Successfully.", "success");
                form.reset();

            } else {

                swal.fire("All Fields Required !", "Please Fill All the Required Fields.", "warning");
