    ...
    -webkit-box-shadow:0 1px 4px rgba(0, 0, 0, 0.1), 0 0 40px rgba(0, 0, 0, 0.1) ;
       -moz-box-shadow:0 1px 4px rgba(0, 0, 0, 0.1), 0 0 40px rgba(0, 0, 0, 0.1) ;
            box-shadow:0 1px 4px rgba(0, 0, 0, 0.1), 0 0 40px rgba(0, 0, 0, 0.1) ;" action="#" class="filter__form">
                    <div class="filter__form__item filter__form__item--search col-5">


                        <div class="kt-widget14__header">
                            <h3 class="kt-widget14__title">
                                Watch Live Gurugedara TV Program
                            </h3>
                    ...
                    <div style="margin-left: 10%;" class="filter__form__item col-5">
                        <p style="text-align: right;"><a href="#" class=""><img width="15%" src="img/tv/live.png"></a></p>


                        <div class="kt-widget14__header kt-margin-b-30">
                            <h2 style="font-size: 28px; color: #E9AD28;">Now Playing </h2> <h3 style="font-weight: 400; margin-bottom: -4%;" class="kt-widget14__title">
                                2020-10-06 | Geography | A/L
                            </h3>
                        ...
                        <h5 style="text-align: left;">
                          ...
                          Followings are the provided materials for the current session. Just click on them to download.
