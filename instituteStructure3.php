...
<div class="container">
    ...
    <ul class="nav nav-tabs">
        <li><a href="instituteStructure1.php">Director General Office</a></li>
        <li><a href="instituteStructure2.php">Humanities, languages and social sciences</a></li>
        <li class="active" style="font-weight: bold; color: #002a80"><a href="instituteStructure3.php">Teacher Education and Alternative Education</a></li>
...
<section id="services" class="ftco-section mt-0 pt-0" style="background-color: white">
    <div class="container mt-0">
        ...
        <div class="row progress-circle pt-md-5">
                ...
                <div class="row">
                    ...
                    <div class="p-md-4 mt-4">
                        <div class="col-md-12 ftco-animate" >
                            <h1 >Faculty of Teacher Education and Alternative Education</h1>
                            <br>
                            <p>Vishrad. Sudath Samarasinghe</p>
                            <p>Deputy Director General</p>
                            <p>	+94-11-7601620</p>
                            <p>+94-11-7601800</p>
                            <p>sudathnva@gmail.com</p>
            ...
            <div class="col-md-5 d-flex align-items-stretch">
                <div class="img w-100" style="background-image: url(img/People/counselor-4305394_1920.jpg);"></div>
            </div>
        </div>
    </div>
</section>
...
<section id="services" class="ftco-section" style="background-color: #e5e5e5">
    <div class="container">
        ...
        <div class="row progress-circle pt-md-5">
            ...
            <div class="col-md-5 d-flex align-items-stretch">
                <div class="img w-100" style="background-image: url(img/People/alejandro-vergara-blanco-872557_1920.jpg);"></div>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row progress-circle pt-md-5">
            <div class="col-md-7 order-md-last py-md-5">
                <div class="row">
                    ...
                    <div class="p-md-4 mt-4">
                        <div class="col-md-12 ftco-animate">
                            <h1>Department of Electronic Dissemination</h1>
                            <br>
                            <p>Mr. R.M.P.C. Ranasinghe</p>
                            <p>Director</p>
                            <p>	+94-11-7601620</p>
                            <p>+94-11-7601800</p>
            ...
            <div class="col-md-5 d-flex align-items-stretch">
                <div class="img w-100" style="background-image: url(img/People/mehrad-vosoughi-iUQmEFtfdLw-unsplash.jpg);"></div>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row progress-circle pt-md-5">
            <div class="col-md-7 order-md-last py-md-5">
                <div class="row">
                    ...
                    <div class="p-md-4 mt-4">
                        <div class="col-md-12 ftco-animate">
                            <h1>Department of Inclusive Education</h1>
                            <br>
                            <p>Mr.K Nawarathna</p>
                            <p>Director </p>
                            <p>	+94-11-7601620</p>
            ...
            <div class="col-md-5 d-flex align-items-stretch">
                <div class="img w-100" style="background-image: url(img/person_4.jpg);"></div>
            </div>
        </div>
    </div>
</section>
