                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="kt_portlet_tab_1_1">
                                ...
                                <div class="row">
                                    ...
                                    <div style="cursor: pointer;" onclick="location.href='down_manage.php';"
                                         class="col-5">
                                                ...
                                                <div class="kt-iconbox__body">
                                                    ...
                                                    <div class="kt-iconbox__desc">
                                                        <h3 class="kt-iconbox__title">
                                                            <a class="kt-link" href="down_manage.php">Manage
                                                                Downloads</a>
                                                        </h3>
                                                    ...
                                                    <div class="kt-iconbox__icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            ...
                                                            <g stroke="none" stroke-width="1" fill="none"
                                                               fill-rule="evenodd">
                                                                <rect x="0" y="0" width="24" height="24"/>
                                                                <path d="M3,5 L21,5 C21.5522847,5 22,5.44771525 22,6 L22,17 C22,17.5522847 21.5522847,18 21,18 L3,18 C2.44771525,18 2,17.5522847 2,17 L2,6 C2,5.44771525 2.44771525,5 3,5 Z M9.632,10.066 L11.032,10.066 L11.032,9.044 L7.035,9.044 L7.035,10.066 L8.435,10.066 L8.435,14 L9.632,14 L9.632,10.066 Z M14.935,14 L16.846,9.044 L15.523,9.044 L14.382,12.558 L14.354,12.558 L13.206,9.044 L11.862,9.044 L13.738,14 L14.935,14 Z"
                                                                      fill="#000000"/>
                                                                <rect fill="#000000" opacity="0.3" x="3" y="19"
                                                                      width="18" height="1" rx="0.5"/>
                                                            </g>
                                                        </svg>
                                                    </div>
                                                    <div class="kt-iconbox__desc">
                                                        ...
                                                        <div class="kt-iconbox__content">
                                                            <a style="color: #9392a0" class="kt-link"
                                                               href="task_add.php">Manage all Supportive Materials for
                                                                Gurugedara</a>
                                                        </div>
                                                    </div>
                                                </div>
