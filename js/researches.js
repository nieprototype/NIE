...
document.querySelector("#thumbnailPath").addEventListener("change", function() {
    const reader = new FileReader();
    reader.addEventListener("load", () => {
...
$(document).ready(function() {
    ...
    console.log(JSON.parse(localStorage.getItem("ResearchAndJournals")).researches.length + JSON.parse(localStorage.getItem("ResearchAndJournals")).journals.length);
